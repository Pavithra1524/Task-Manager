...
const TaskDetail = () => {
  ...
  if (!id || isNaN(Number(id))) {
    console.error('[TaskDetail] Invalid or missing task id:', id);
    return <div className="py-10 text-red-500 text-center">Invalid or missing task ID.</div>;
  }
    ...
    <div className='w-full flex flex-col gap-3 mb-4 overflow-y-hidden'>
      ...
      <Tabs tabs={TABS} setSelected={setSelected}>
        {selected === 0 ? (
          ...
          <Activities activity={task.activities || []} id={task.id} refetch={refetch} />
        )}
      </Tabs>
                  ...
                  <div className='space-y-4 py-6'>
                    ...
                    <div className='space-y-8'>
                      {task?.subTasks?.map((el, index) => (
                        <div key={index + el?.id} className='flex gap-3'>
